...
The proposed separation of the unpublished Buffer project from its published
Warehouse predecessor is in [docs/buffer-migration.md](docs/buffer-migration.md).
